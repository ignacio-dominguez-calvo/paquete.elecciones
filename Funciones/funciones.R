...
leer_datos <- function(tipo_eleccion, año, mes, ambito,directorio = "./descargas/"){
...
df2<-leer_datos('02', '2019', '04', 'muni')

descargar_Archivo(tipo_eleccion = 'congreso',año = 2019, mes = 4, ambito = 'mesa')
